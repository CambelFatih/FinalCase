using BSYS.Application.Features.Commands.AuthorizationEndpoint.AssignRoleEndpoint;
using BSYS.Application.Features.Queries.AuthorizationEndpoint.GetRolesToEndpoint;
using MediatR;
