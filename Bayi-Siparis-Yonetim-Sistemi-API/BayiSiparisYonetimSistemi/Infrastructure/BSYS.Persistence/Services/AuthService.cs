...
using BSYS.Application.DTOs.Facebook;
using BSYS.Application.Helpers;
using BSYS.Domain.Entities.Identity;
using BSYS.Application.Exceptions;
...
public class AuthService : IAuthService
{
    ...
    async Task<Token> CreateUserExternalAsync(AppUser user, string email, string name, UserLoginInfo info, int accessTokenLifeTime)//eğer kullanıcı sisteme kayıtlı değilse google ve facebook kullanarak hızlı birşekilde otomatik kayıt oluşturuyor 
    {
